...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="edit2.php?id=<?php echo $id;?>&num=<?php echo $num;?>" enctype='multipart/form-data'>
      <div class="form-group">
        <div class="label">
          <label>标题：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" value="<?php echo $title;?>" name="title" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <!-- <input type="file" id="url1"  name="img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" /> -->
           ...
           <!--  <img id="imgFile" src="upimg/timg.jpg" width="250px" height="250px"> -->
            ...
            <input type="text" value="<?php echo $imgpath;?>" name="imagepath" id="imagepath" style=""/>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <textarea name="content" class="input" style="height:200px; border:1px solid #ddd;"><?php echo $content;?></textarea>
          <div class="tips"></div>
        </div>
      </div>
